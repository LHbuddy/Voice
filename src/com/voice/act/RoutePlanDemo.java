...
public class RoutePlanDemo extends Activity implements
	...
	public void searchButtonProcess(View v) {
		...
		PlanNode stNode1 = PlanNode.withCityNameAndPlaceName("北京", editSt
				.getText().toString());
		PlanNode enNode1 = PlanNode.withCityNameAndPlaceName("北京", editEn
				.getText().toString());
		if (editSt.getText().toString().equals("当前位置")) {
			stNode1 = stNode;
			enNode1 = enNode;
		}
	...
	public void searchProcess(String start, final String end) {
		...
		if (start.equals("CURRENT_POI")) {
			editSt.setText("当前位置");
			Toast.makeText(RoutePlanDemo.this, "正在定位当前位置", 1).show();
			new Thread() {
				public void run() {
					try {
						while (true) {
			...
			stNode = PlanNode.withCityNameAndPlaceName("北京", start);
			enNode = PlanNode.withCityNameAndPlaceName("北京", end);
	...
	public class MyLocationListenner implements BDLocationListener {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			Toast.makeText(RoutePlanDemo.this, "定位成功", 1).show();
